...
/*   Updated: 2022/03/01 19:53:22 by mlanca-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*scan_name(void)
{
	...
	static char	*type[] = {"controllers_get_envp", "scan_controllers",
		...
		"test_filename_expansion", "test_quote_removal", "test_cd", "test_echo",
		"test_env", "test_export", "test_pwd", NULL};
...
static int	scan_next(void)
{
	...
	static test_fn	fn[] = {test_controllers_get_envp, test_scan_controllers,
		...
		test_quote_removal, test_cd, test_echo, test_env, test_export, test_pwd,
		NULL};
